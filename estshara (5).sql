...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2022 at 04:03 PM
...
--
-- Table structure for table `roles__`
--

CREATE TABLE `roles__` (
  `id` int(11) NOT NULL,
  `type` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `roles__`
--

INSERT INTO `roles__` (`id`, `type`) VALUES
(1, 'admin');
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `city_id`, `birth_date`, `email_isverified`, `avatar`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `phone`, `phone_isverified`, `device_token`, `join_date`, `active`, `device_info`, `last_login`) VALUES
(1, 1, 'fatma', 'fatma@fatma.com', 0, '0000-00-00', 0, NULL, NULL, '$2y$10$FH7pwqLVcvu.mZnETmAHGebZxi1iebYmEv4fi8FDIbUAgfqaydbR2', NULL, '2022-09-06 12:48:07', '2022-09-06 12:48:07', NULL, '', 0, '1', '2022-09-06 14:48:07', 1, NULL, NULL);
...
--
-- AUTO_INCREMENT for table `roles__`
--
ALTER TABLE `roles__`
