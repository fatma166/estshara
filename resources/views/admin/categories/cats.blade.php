                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body fw-semibold">مستحضرات التجميل</a>
                                                        </td>
                                                        <td>
                                                            4958
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="{{asset('images/users/user-2.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                                            <a href="javascript:void(0);" class="text-body fw-semibold">ادوية عامة</a>
                                                        </td>
                                                        <td>
                                                            4958
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="{{asset('images/users/user-2.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                                            <a href="javascript:void(0);" class="text-body fw-semibold">ادوية تجميل</a>
                                                        </td>
                                                        <td>
                                                            4958
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-user">
                                                            <img src="{{asset('images/users/user-2.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                                            <a href="javascript:void(0);" class="text-body fw-semibold">نظافة عامة</a>
                                                        </td>
                                                        <td>
                                                            4958
                                                        </td>
