            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">الصيدليات</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div class="row justify-content-between mb-2">
                                ...
                                <div class="col-md-6">
                                    <div class="text-md-end">
                                        <a href="#" class="btn btn-danger waves-effect waves-light mb-2 me-2"><i class="mdi mdi-basket me-1"></i> انشاء صيدلية</a>
                                    </div>
                                </div><!-- end col-->
                            </div>

                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap table-borderless table-hover mb-0" id="pharmacy-datatable">
